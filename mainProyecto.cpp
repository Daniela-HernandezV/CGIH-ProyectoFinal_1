...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		if (movSol >= 1000.0f && dia == 0) {
			R = 0.0f;
			G = 0.0f;
		}

		if (movSol <= -500 && movSol >= -1000 && dia == 0) {
			R -= (deltaTime * 0.0002);
			G -= (deltaTime * 0.0002);
		...
		if ((movSol > 995 && movSol <= 1000 || movSol < -995 && movSol >= -1000) && dia == 0) {
			std::vector<std::string> skyboxFaces;
		...
		if ((movSol > 845 && movSol <= 850 || movSol < -845 && movSol >= -850) && dia == 0) {
			std::vector<std::string> skyboxFaces;
		...
		if ((movSol > 745 && movSol <= 750 || movSol < -745 && movSol >= -750) && dia == 0) {
			std::vector<std::string> skyboxFaces;
		...
		if ((movSol <= 650 && movSol >= 645 || movSol <= -645 && movSol >= -650) && dia == 0) {
			std::vector<std::string> skyboxFaces;
		...
		mainLight = DirectionalLight(G, R, B,
			(G / 2) + 0.1f, (G/ 2) + 0.1f,
			movSol, -500.0f, 0.0f);
